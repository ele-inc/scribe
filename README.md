...
- **Cloud storage integration:** Supports Google Drive and Dropbox video/audio links for transcription
...
@bot https://www.dropbox.com/s/xxxxx/audio.mp4?dl=0 --num-speakers 2
